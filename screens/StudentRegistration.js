...
const StudentRegistration = () => {
  ...
  const [imgplaceholder, setImgplaceholder] = useState('Upload Image');
    ...
    const unsubscribe = NetInfo.addEventListener(state => {
      ...
      if (state.isConnected === true) {
        ...
        const userRegistered = async () => {
          ...
          const img = await AsyncStorage.getItem('@studentImage');
          const course = await AsyncStorage.getItem('@COURSES');
         
          if (data !== null && img !== null && course !== null) {
            navigate.dispatch(StackActions.replace('TabNavigator'));
          } else {
            console.log('YOU DONT HAVE ANY DATA IN YOU ASYNC STORAGE');
                ...
                if (value !== null) {
                  ...
                  const getStudent = async () => {
                    await axios
                      ...
                      .then(res => {
                        //get status
                        console.log(res.data, 'IM STUDENT FROM REGISTRATION');
          ...
          <SafeAreaView>
            <Formik
                  ...
                  .then(res => {
                    if (isImg) {
                      ...
                      axios
                        ...
                        .then(res => {
                          console.log(res.data, 'RESPONSE FROM DEGREE');
                        })
                        .catch(err => {
              ...
              {({
                ...
                <>
                  {/* BREAK FORM IN 3 FILED EACH IN IOS */}
                  {Platform.OS === 'ios' ? (
                    <ScrollView>
                      <Text
                        style={{
